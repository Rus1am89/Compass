...
public class CompassAuthenticator extends AuthAuthenticator {

    private final Context mContext;

    public CompassAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType,
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (!TextUtils.isEmpty(password)) {
                // Todo
//                authToken = AuthLoginActivity.signIn(mContext, account.name, password);
            }
        }
        if (!TextUtils.isEmpty(authToken)) {
